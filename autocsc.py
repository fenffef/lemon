...
import copy
from transformers import AutoModel, BertPreTrainedModel, BertModel, BertForMaskedLM, RoCBertForSequenceClassification, BartModel, AutoTokenizer, RoCBertPreTrainedModel, RoCBertForMaskedLM, BartForConditionalGeneration
...
class AutoCSCroc(RoCBertForSequenceClassification):
    def __init__(self, config):
        super().__init__(config)
        self.num_labels = config.vocab_size
...
class AutoCSCROCSoftMasked(RoCBertPreTrainedModel):
    def __init__(self, config):
        super().__init__(config)
        self.num_labels = config.vocab_size
...
class AutoCSCROCMDCSpell(RoCBertPreTrainedModel):
    def __init__(self, config):
        super().__init__(config)
        self.num_labels = config.vocab_size
